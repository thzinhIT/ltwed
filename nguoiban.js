...
document.addEventListener("DOMContentLoaded", function () {
      ...
      datasets: [
        {
          ...
          data: [
            10000000, 12000000, 15000000, 14000000, 18000000, 21000000,
            16000000, 17000000, 22000000, 25000000, 30000000, 32000000,
          ],
  ...
  const ctxSpiral = document
    .getElementById("revenue-chart-spiral")
    .getContext("2d");
  const spiralData = [];
  for (let i = 0; i < 30; i++) {
...
document
  .querySelector(".nav-link[data-section='revenue-section']")
